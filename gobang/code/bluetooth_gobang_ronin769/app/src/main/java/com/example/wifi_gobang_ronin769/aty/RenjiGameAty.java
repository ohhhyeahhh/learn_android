...
import com.example.wifi_gobang_ronin769.utils.DBUtils;
import com.example.wifi_gobang_ronin769.view.RenjiGobangView;
...
public class RenjiGameAty extends Activity implements RenjiGobangView.OnWinListener
{
    ...
    private void initView() {
        ...
        renjibeijing =  findViewById(R.id.renjibeijingdongtu);
...
//            editText =  mydialog.getWindow().findViewById(R.id.windialog_ev);


            TextView showview =  mydialog.getWindow().findViewById(R.id.windialog_tv);
