package com.example.wifi_gobang_ronin769.adapter;
...
import com.example.wifi_gobang_ronin769.bean.Device;
...
public class DeviceshowAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        device_ifchoiseimg =  v.findViewById(R.id.device_ifchoiseimg);
        device_ifchoise =  v.findViewById(R.id.device_ifchoise);
